  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 px-2 py-4 sm:px-4 sm:py-8">
      <div className="max-w-3xl mx-auto bg-white p-3 sm:p-6 rounded-xl shadow-lg">
        ...
        {result && (
          <>
            <div className="mt-6 sm:mt-8 bg-emerald-50 border border-emerald-200 p-4 sm:p-6 rounded-lg shadow">
              <h2 className="text-lg sm:text-xl font-semibold text-emerald-700 mb-3">Hasil Diagnosa</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-gray-700 text-sm">
            ...
            <div className="mt-6 sm:mt-8">
              <h3 className="text-base sm:text-lg font-semibold text-emerald-700 mb-2">Grafik Tinggi per Usia (HAZ)</h3>
              <div className="w-full h-[220px] sm:h-[300px] bg-white rounded-lg shadow border border-emerald-100 p-2 sm:p-4">
            ...
            {/* Grafik WHZ */}
            <div className="mt-6 sm:mt-8">
              <h3 className="text-base sm:text-lg font-semibold text-emerald-700 mb-2">Grafik Berat per Tinggi (WHZ)</h3>
              <div className="w-full h-[220px] sm:h-[300px] bg-white rounded-lg shadow border border-emerald-100 p-2 sm:p-4">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <section className="mt-12 sm:mt-16 bg-gradient-to-b from-white to-emerald-50 p-4 sm:p-8 rounded-xl shadow-md border border-emerald-200">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-emerald-700 mb-4 sm:mb-6 text-center">
          ...
          <p className="text-gray-700 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6 text-justify">
            <strong>NutriKids Expert</strong> adalah <strong>sistem pakar gizi anak berbasis web</strong> yang membantu orang tua dan tenaga medis mendiagnosis status gizi balita secara cepat dan akurat. Sistem ini menggunakan <strong>AI</strong> dengan <strong>metode Forward Chaining</strong> dan seluruh acuan diagnosa merujuk pada <strong>standar WHO</strong>.
          </p>
          <div className="flex flex-col gap-4 sm:grid sm:grid-cols-2 sm:gap-8 text-sm sm:text-base text-gray-700">
            {/* Box 1 - Metode */}
            <div className="bg-emerald-100 rounded-lg p-3 sm:p-4 shadow-sm">
              <h4 className="text-emerald-700 font-semibold text-base sm:text-lg mb-2">📌 Metode Diagnosa</h4>
              <p className="leading-relaxed text-justify">
                Forward Chaining: sistem menganalisis data awal (usia, berat, tinggi, jenis kelamin), menghitung <strong>Z-score HAZ & WHZ</strong>, lalu menelusuri basis pengetahuan untuk menemukan <strong>diagnosa yang sesuai</strong>.
              </p>
            </div>
            {/* Box 2 - Input */}
            <div className="bg-emerald-100 rounded-lg p-3 sm:p-4 shadow-sm">
              <h4 className="text-emerald-700 font-semibold text-base sm:text-lg mb-2">📝 Data yang Diperlukan</h4>
            ...
            {/* Box 3 - Output */}
            <div className="bg-emerald-100 rounded-lg p-3 sm:p-4 shadow-sm">
              <h4 className="text-emerald-700 font-semibold text-base sm:text-lg mb-2">📈 Hasil Diagnosa</h4>
              <ul className="list-disc list-inside space-y-1">
                <li>Z-score HAZ (Height-for-Age)</li>
                <li>Z-score WHZ (Weight-for-Height)</li>
                <li>Kategori status gizi WHO</li>
            ...
            {/* Box 4 - Klasifikasi */}
            <div className="bg-emerald-100 rounded-lg p-3 sm:p-4 shadow-sm">
              <h4 className="text-emerald-700 font-semibold text-base sm:text-lg mb-2">🔍 Klasifikasi Status Gizi</h4>
              <p className="mb-2">Kategori gizi anak menurut WHO:</p>
              <ul className="list-disc list-inside space-y-1">
          ...
          {/* Penutup */}
          <div className="mt-6 sm:mt-8 text-xs sm:text-sm text-gray-600 border-t pt-3 sm:pt-4">
